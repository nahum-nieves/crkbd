...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
        ...
        KC_TAB,KC_NO,KC_NO,KC_NO,KC_PSCR,RESET,                            KC_PPLS,TD(TD_UP_PGUP),KC_PMNS,KC_7,KC_8,KC_9,
        KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,                               TD(TD_LEFT_HOME),TD(TD_DOWN_PGDN),TD(TD_RIGHT_END),KC_4,KC_5,KC_6,
